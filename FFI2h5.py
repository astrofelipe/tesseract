...
dset   = output.create_dataset('FFIs', (nx, ny, nfiles), dtype='float64', chunks=(16, 16, nfiles//4), compression='lzf')
derr   = output.create_dataset('errs', (nx, ny, nfiles), dtype='float64', chunks=(16, 16, nfiles//4), compression='lzf')
