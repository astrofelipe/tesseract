...
dset   = output.create_dataset('FFIs', (nfiles, nx, ny), dtype='float64', chunks=(16, 48, 48), compression='lzf')
derr   = output.create_dataset('errs', (nfiles, nx, ny), dtype='float64', chunks=(16, 48, 48), compression='lzf')
