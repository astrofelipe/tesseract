...
dset   = output.create_dataset('FFIs', (nfiles, nx, ny), dtype='float64', chunks=(4, 24, 24), compression='gzip')
derr   = output.create_dataset('errs', (nfiles, nx, ny), dtype='float64', chunks=(4, 24, 24), compression='gzip')
