...
dset   = output.create_dataset('FFIs', (nfiles, nx, ny), dtype='float64', compression='gzip')#, chunks=(20, 64, 64))
derr   = output.create_dataset('errs', (nfiles, nx, ny), dtype='float64', compression='gzip')#, chunks=(20, 64, 64))
