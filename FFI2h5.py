...
dset   = output.create_dataset('FFIs', (nx, ny, nfiles), dtype='float64', chunks=(64, 64, 1), compression='lzf')
derr   = output.create_dataset('errs', (nx, ny, nfiles), dtype='float64', chunks=(64, 64, 1), compression='lzf')
