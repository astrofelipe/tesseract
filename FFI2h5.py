...
dset   = output.create_dataset('FFIs', (nfiles, nx, ny), dtype='float64', chunks=(5, 32, 32), compression='lzf')
derr   = output.create_dataset('errs', (nfiles, nx, ny), dtype='float64', chunks=(5, 32, 32), compression='lzf')
