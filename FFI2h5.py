...
dset   = output.create_dataset('FFIs', (nfiles, nx, ny), dtype='float64', chunks=True)#, compression='lzf')
derr   = output.create_dataset('errs', (nfiles, nx, ny), dtype='float64', chunks=True)#, compression='lzf')
table  = output.create_dataset('data', (4, nfiles), dtype='float64', chunks=True)#, compression='lzf')
