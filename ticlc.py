...
from astropy.visualization import MinMaxInterval, SinhStretch, ImageNormalize, AsymmetricPercentileInterval, MinMaxInterval, LogStretch, ContrastBiasStretch
...
if args.pngstamp is not None:
    ...
    norm      = ImageNormalize(mstamp, interval=AsymmetricPercentileInterval(0,99), stretch=LogStretch(a=250))
