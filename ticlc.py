...
from astropy.visualization import MinMaxInterval, LogStretch, SinhStretch, ImageNormalize, PercentileInterval
...
if args.pngstamp is not None:
    ...
    norm      = ImageNormalize(mstamp, interval=PercentileInterval(0.66), stretch=SinhStretch())
