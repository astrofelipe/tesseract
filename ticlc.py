...
from astropy.visualization import MinMaxInterval, LogStretch, SqrtStretch, ImageNormalize, AsymmetricPercentileInterval
...
if args.pngstamp is not None:
    ...
    norm      = ImageNormalize(mstamp, interval=AsymmetricPercentileInterval(50,100))#, stretch=SqrtStretch())
